    ...
    <div>
      ...
      <Container>
        <div className='max-w-xl shadow p-10 mx-auto mt-10 lg:mt-16'>
          <h1 className='text-4xl font-medium text-heading mb-4'>Order Tracking</h1>
          ...
          <button className='text-lg font-normal text-center text-white hover:text-primary bg-primary hover:bg-transparent border-2 border-transparent hover:border-2 hover:border-primary duration-300 transition-all py-3 px-4 w-full mt-2'
          type='submit'>Track Now</button>    
        </form>
        </div>
