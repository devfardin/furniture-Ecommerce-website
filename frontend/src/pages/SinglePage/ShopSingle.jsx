            ...
            <Container>
                <div className='grid grid-cols-1 md:grid-cols-8 lg:grid-cols-8 mt-20 gap-12'>
                    <div className='col-span-4'>
                        <img src="https://furniture.nazmart.net/assets/tenant/uploads/media-uploader/furniture/frame-346211672748268.png" alt="Product Image" />
                    </div>
                    <div className='col-span-4'>
                        <h1 className='text-3xl font-medium text-heading mb-2'>Odrex Double Bed</h1>
                        <span className='bg-[#5AB27E] px-2 py-0.5 text-sm font-normal text-white'>New Arival</span>

                        {/* Product status */}
                        <div className='w-32 my-4 flex justify-between items-center'>
                            <span className='text-base font-medium text-pera'>Status: </span>
                            <span className='text-base font-semibold text-[#198754]'>In Stock</span>
                        </div>
                        {/* Product Price */}
                        <div className='w-36 mt-4 flex justify-between items-center'>
                            <span className='text-xl font-medium text-pera'>$7,500</span>
                            <span className='text-xl font-medium text-[#888888] line-through'>$8000</span>
                        </div>
                        {/* Product Short Description */}
                        <p className='text-pera text-base font-normal my-5'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Fugit molestiae accusamus consequuntur laboriosam unde sequi, Lorem ipsum dolor sit amet.</p>
                        {/* Product quantity manage */}
                        <div className='flex items-center  gap-6'>
                            <h1 className='text-base font-medium text-pera'>Quantity:</h1>
                            <div className='flex items-center gap-3'>
                                <button onClick={() => productQuantity > 1 ? setProductQuantity(productQuantity - 1) : ''}
                                    className='p-3 bg-[#F1F1F1] outline-none'><FiMinus className='text-2xl' /></button>
                                <input type="number" value={productQuantity}
                                    className='bg-[#F1F1F1] p-2.5 w-[60px] outline-none text-center text-lg font-normal' />
                                <button onClick={() => setProductQuantity(productQuantity + 1)} className='p-3 bg-[#F1F1F1] outline-none'>
                                    <FiPlus className='text-2xl' />
                                </button>
                            </div>
                            <h1 className='text-base font-medium text-[#198754]'>Only! 97 Item Left</h1>
                        </div>
                        ...
                        <div className='flex justify-center gap-2 mt-8 flex-col'>
                            <div className='flex items-center gap-3'>
                                ...
                                <span className='text-base font-normal text-[#198754]'>ELWDNT001</span>
                            </div>

                            <div className=' flex items-center gap-3'>
                                <span className='text-base font-normal text-pera'>Category: </span>
