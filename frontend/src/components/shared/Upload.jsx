...
const Uploaded = ({ imageUrl, setImageUrl }) => {
  const [showName, setShowName] = useState({});
  setImageUrl(showName);
  ...
  return (
    <div className="">
      {showName?.name ? (
        <div className="!max-w-full flex items-center gap-x-6  rounded-lg border-2 border-dashed border-gray-400 p-3 bg-white">
          <img
