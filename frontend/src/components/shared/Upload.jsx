...
const Uploaded = () => {
    ...
    mediaUpload(showName)
    .then( success=>{
        toast.success('Profile image succes fully uploadd')
  ...
  return (
    <div className="">
    {showName?.name ? (
      <div className="!max-w-full flex ju items-center gap-x-6  rounded-lg border-2 border-dashed border-gray-400 p-5 bg-white">
        <img className="w-full max-w-[150px] rounded-lg object-cover" src={showImagePreview} alt={showName?.name} />
